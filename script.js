...
const API_KEY = "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";
...
(() => {
  ...
  const isDarkTheme = savedTheme === "dark" || (!savedTheme && systemPreferredDark);
...
const handleFormSubmit = (e) => {
  ...
  const selectModel = modelSelect.value || "runwayml/stable-diffusion-v1-5";
